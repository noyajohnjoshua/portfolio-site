  ...
  return (
    <html lang="en" className="h-full">
      <head>
        ...
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-27CJ40YKBZ"
        />
        <script
...
})(window,document,'script','dataLayer','GTM-KMPF38BD');`}
        </Script>
        {/* Google Tag Manager (noscript) */}
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-KMPF38BD"
            height="0"
            width="0"
